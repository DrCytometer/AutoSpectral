...
So much faster! We don't get plots because we aren't changing anything and you should have already looked at the data before you did this. The new automated pipeline does not use gating, instead selecting cells based on stuff that isn't autofluorescence directly.
