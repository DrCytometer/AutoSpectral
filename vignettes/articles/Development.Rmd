...
* Parallelization improvements. 
  ...
  + A new parallel backend using `parLapply` on Windows or `mclapply` on Mac/Linux is being implemented in `dev` branch. This should gracefully fall back to sequential `lapply` processing if it runs into any problems.
