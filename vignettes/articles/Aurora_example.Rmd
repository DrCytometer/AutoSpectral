---
title: "Aurora AutoSpectral Example"
---
...
For now, we'll use the pre-filled control file, which you can get from Mendeley Data at https://data.mendeley.com/datasets/xzt3h3gnx9/1
```{r, eval=FALSE}
