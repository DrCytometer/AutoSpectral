...
Note that the "fast" approach in version 1.0.0 is very different from the "fast" approximation in earlier version of AutoSpectral. It is not expected to produce any substantial discontinuities in the data--if you see this, please reach out (data will be helpful in identifying any issues). Further work on improving this is ongoing.
