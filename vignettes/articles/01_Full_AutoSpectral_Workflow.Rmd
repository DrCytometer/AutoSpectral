...
```
Be sure to check the gates that are generated in the `figure_gate` folder--do they look right? If not, go to the Gating article on [GitHub](https://drcytometer.github.io/AutoSpectral/articles/Gating.html) [Colibri](https://www.colibri-cytometry.com/post/autospectral-gating) for tips on how fix it.
