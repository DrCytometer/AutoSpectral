...
Be sure to check the gates that are generated in the `figure_gate` folder--do they look right? If not, go to the Gating articles on [GitHub](https://drcytometer.github.io/AutoSpectral/articles/04_Gating.html) [Colibri](https://www.colibri-cytometry.com/post/autospectral-gating) for tips on how fix it.
...
And here we have the attempt to gate out and exclude intrusive autofluorescence in the CD11b BUV805 single-stained control. BUV805 will peak in UV16-A on the Cytek Aurora, while autofluorescence often apeasr in UV7-A (although this is determined empirically and automatically by AutoSpectral).
...
This will be fine.
![BUV805 QC](figures/Workflow/BUV805_QC.jpg)
![BUV805 scatter matching](figures/Workflow/BUV805_scatter_match.jpg)
The scatter matching is too loose here.
