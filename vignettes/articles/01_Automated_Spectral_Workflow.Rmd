...
**Spectral traces and heatmap** — the same standard outputs as the legacy
...
**Hotspot matrix** — highlights fluorophore pairs with high spectral overlap,
...
to most AF-like, and the retained subset is highlighted. This is useful for
diagnosing controls where the AF and fluorophore signals are hard to separate.
...
spectral events, and the matched AF events used for subtraction. Inspect these
to confirm the pairing is sensible for each control.
