...
3. **Cosine-similarity filtering** — top-expressing candidate events are
...
4. **KNN scatter-matched AF subtraction** — for each retained event, the
...
5. **Automated QC with legacy pipeline fallback** — the resulting spectrum is 
...
online viewers such as [Cytek Cloud](https://cloud.cytekbio.com/).
