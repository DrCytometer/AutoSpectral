...
sometimes perfect for unmixing and is at other times very odd.
Unfortunately, it appears the information on spillover values is not
always accurately encoded in the .Expt files, so this function may be
