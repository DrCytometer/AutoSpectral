...
- af.basis:
  ...
  When `NULL` and `bg.mode = "af.deconv"`, it is built from `af.spectra`
  (computed internally via
  [`get.af.spectra()`](https://drcytometer.github.io/AutoSpectral/reference/get.af.spectra.md)
  with its own defaults, if not already supplied) and `spectra`. Default
  `NULL`.

- af.n.pc:

  Unused when `bg.mode = "af.deconv"`;
  [`get.af.basis.library()`](https://drcytometer.github.io/AutoSpectral/reference/get.af.basis.library.md)
  is called with its own defaults (`n.components = NULL`,
  `var.explained = 0.99`). Retained for backward compatibility. Default
  `"auto"`.
...
- af.spectra:
  ...
  [`get.af.spectra()`](https://drcytometer.github.io/AutoSpectral/reference/get.af.spectra.md).
  Required, with at least two rows, when `bg.mode = "per.cell"`. When
  `bg.mode = "af.deconv"` and `af.basis` is `NULL`, supplying this skips
  the internal
  [`get.af.spectra()`](https://drcytometer.github.io/AutoSpectral/reference/get.af.spectra.md)
  call. Unused otherwise.
