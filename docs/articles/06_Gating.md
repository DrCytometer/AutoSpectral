...
suggestions here. From what I’ve seen, this would be much faster in
Python.
...
and you should have already looked at the data before you did this. The
new automated pipeline does not use gating, instead selecting cells
based on stuff that isn’t autofluorescence directly.
